...
namespace Mario_Bros.Framework
{
    public enum IDResource
    {
        ...
        // BG UI ----> Here Tran Danh's Code. Imma God
        #region Code Danh
        INTRO_1,
        INTRO_2,
        BLACK,
    ...
    public class CResourceManager
    {
        ...
        #region Sounds
        private SoundEffect sfx_1_up;
        private SoundEffect sfx_breakblock;
        private SoundEffect sfx_bump;
        private SoundEffect sfx_coin;
        private SoundEffect sfx_fireball;
        private SoundEffect sfx_firework;
        private SoundEffect sfx_flagpole;
        private SoundEffect sfx_gameover;
        private SoundEffect sfx_jump_small;
        private SoundEffect sfx_jump_big;
        private SoundEffect sfx_kick;
        private SoundEffect sfx_mario_die;
        private SoundEffect sfx_mario_hurt;
        private SoundEffect sfx_pause;
        private SoundEffect sfx_pipe;
        private SoundEffect sfx_power_up;
        private SoundEffect sfx_item_appear;
        private SoundEffect sfx_stage_clear;
        private SoundEffect sfx_stomp;
        private SoundEffect sfx_vine;
        private SoundEffect sfx_warning;
        private SoundEffect sfx_world_clear;
        private Song m_ThemeSong;
        ...
        public void Init(ContentManager _ContentManager)
        {
            ...
            #region Sounds
            sfx_1_up = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_1-up");
            sfx_breakblock = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_breakblock");
            sfx_bump = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_bump");
            sfx_coin = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_coin");
            sfx_fireball = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_fireball");
            sfx_firework = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_fireworks");
            sfx_flagpole = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_flagpole");
            sfx_gameover = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_gameover");
            sfx_item_appear = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_powerup_appears");
            sfx_jump_big = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_jump-super");
            sfx_jump_small = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_jump-small");
            sfx_kick = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_kick");
            sfx_mario_die = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_mariodie");
            sfx_mario_hurt = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_mariohurt");
            sfx_pause = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_pause");
            sfx_pipe = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_pipe");
            sfx_power_up = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_powerup");
            sfx_stage_clear = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_stage_clear");
            sfx_stomp = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_stomp");
            sfx_vine = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_vine");
            sfx_warning = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_warning");
            sfx_world_clear = _ContentManager.Load<SoundEffect>("Audio/Game Audio/smb_world_clear");
            m_ThemeSong = _ContentManager.Load<Song>("Audio/Song/ThemeSong");
            m_IntroSong = _ContentManager.Load<Song>("Audio/Song/Intro");
            #endregion
            // Danh's code
